(function(c) {
        ...
        h = function() {
            ...
            a.prototype.parent = function() {
                return new a(c(this).map(function() {
                    var b = new a(this);
                    return b.is(":upper") ? null : c(b.is(":toggle") ? this.parentNode.parentNode : this).closest(".dropdown").find('>[data-toggle="dropdown-submenu"]')[0]
                }), this)
            };
            ...
            a.prototype.jump = function(b) {
                ...
                var d;
                d = this.eq(0);
                d = this.is(":flat") || d.is(":upper") ? d.root().children(this.is(":flat")) : d.parent().children();
    ...
    f.prototype.toggle = function(a) {
        ...
        if (b) return !1;
        "ontouchstart" in document.documentElement && !a.closest(".dropdown.open").length && (b = document.createElement("div"), b.className = "dropdown-backdrop", c(b).insertBefore(c(this).closest(".nav-dropdown")), c(b).on("click", f._clearMenus));
        b = {
            relatedTarget: this
        };
    ...
    f._clearMenus = function(a) {
        ...
        if (3 !== a.which) {
            ...
            if (a.target) {
                ...
                c(a.target).is('[data-toggle="dropdown-submenu"]') ? d = c(a.target.parentNode).parents(".dropdown").find('>[data-toggle="dropdown-submenu"]') : c(".dropdown-backdrop").remove()
            }
    ...
    c(document).on("keydown.bs.nav-dropdown.data-api", ".nav-dropdown", f._dataApiKeydownHandler).on("collapse.bs.navbar-dropdown", f._clearMenus).on("click.bs.nav-dropdown.data-api", f._clearMenus).on("click.bs.nav-dropdown.data-api", '[data-toggle="dropdown-submenu"]', f.prototype.toggle).on("click.bs.nav-dropdown.data-api", ".dropdown form", function(a) {
        a.stopPropagation()
    });
